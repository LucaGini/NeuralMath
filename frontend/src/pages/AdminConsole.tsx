...
export const AdminConsole: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#090d16] math-grid text-slate-800 dark:text-slate-100 pb-16 transition-colors duration-200">
      <Navbar />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            <div className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-amber-500 mb-1.5">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800 text-xs font-bold uppercase tracking-wider text-slate-600 dark:text-slate-350 transition-all self-start md:self-auto"
          >
        ...
        {/* Tab Headers */}
        <div className="flex overflow-x-auto gap-2 bg-white/70 dark:bg-[#0c1220]/50 p-1.5 rounded-2xl border border-slate-250/50 dark:border-slate-800/80 mb-8 scrollbar-none">
          <button
            ...
            className={`flex items-center gap-2 px-5 py-3 rounded-xl text-xs font-black uppercase tracking-wider transition-all whitespace-nowrap ${
              activeTab === "stats"
                ...
                : "text-slate-500 hover:text-slate-850 dark:text-slate-400 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800/60"
            }`}
          >
            ...
            {statsLoading ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white/80 dark:bg-[#0c1220]/80 backdrop-blur-md rounded-3xl border border-slate-200 dark:border-slate-800/80 p-6 shadow-md transition-all relative overflow-hidden">
                    <div className="absolute -top-6 -right-6 w-16 h-16 bg-amber-500/10 rounded-full blur-lg" />
                    ...
                    <h3 className="text-4xl font-extrabold text-slate-850 dark:text-white">
                      {stats?.total_users || 0}
                    </h3>
                  </div>

                  <div className="bg-white/80 dark:bg-[#0c1220]/80 backdrop-blur-md rounded-3xl border border-slate-200 dark:border-slate-800/80 p-6 shadow-md transition-all relative overflow-hidden">
                    <div className="absolute -top-6 -right-6 w-16 h-16 bg-blue-500/10 rounded-full blur-lg" />
                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 block mb-1">
                  ...
                  <div className={`bg-white/80 dark:bg-[#0c1220]/80 backdrop-blur-md rounded-3xl border p-6 shadow-md transition-all relative overflow-hidden ${
                    stats ? getErrorRateBadgeClass(stats.agent_error_rate).split(" ")[1] : "border-slate-200 dark:border-slate-800/80"
                  }`}>
                    <div className="absolute -top-6 -right-6 w-16 h-16 bg-red-500/10 rounded-full blur-lg" />
                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 block mb-1">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  {/* DAU Line Chart */}
                  <div className="lg:col-span-2 bg-white/80 dark:bg-[#0c1220]/80 backdrop-blur-md rounded-3xl border border-slate-200 dark:border-slate-800/80 p-6 shadow-md">
                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 block mb-4">
                  ...
                  <div className="bg-white/80 dark:bg-[#0c1220]/80 backdrop-blur-md rounded-3xl border border-slate-200 dark:border-slate-800/80 p-6 shadow-md">
                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 block mb-4">
                    ...
                    <div className="space-y-4">
                      {stats?.top_topics && stats.top_topics.length > 0 ? (
                        stats.top_topics.map((t, idx) => (
                          <div 
                            key={idx}
                            className="flex items-center justify-between p-3 rounded-2xl bg-slate-50/50 dark:bg-[#090d16]/50 border border-slate-200/50 dark:border-slate-850/60"
                          >
                            <div className="flex items-center gap-3">
                              <span className="w-6 h-6 rounded-lg bg-amber-500/10 text-amber-600 dark:text-amber-400 font-black text-xs flex items-center justify-center">
                                {idx + 1}
                              </span>
        ...
        {/* ==================== 2. STUDENTS TAB ==================== */}
        {activeTab === "users" && (
          <div className="bg-white/80 dark:bg-[#0c1220]/80 backdrop-blur-md rounded-3xl border border-slate-200 dark:border-slate-800/80 shadow-md p-6 overflow-hidden">
            ...
            <form onSubmit={handleUserSearch} className="flex gap-2 max-w-md mb-6">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-[#090d16]/50 border border-slate-200 dark:border-slate-800 rounded-2xl pl-11 pr-4 py-2.5 text-xs font-medium focus:outline-none focus:border-amber-500 dark:focus:border-amber-500 transition-all text-slate-800 dark:text-white"
                />
              </div>
              <button
                type="submit"
                className="bg-amber-500 hover:bg-amber-400 text-white text-xs font-black uppercase tracking-widest px-5 py-2.5 rounded-2xl shadow-md shadow-amber-500/10 transition-all"
              >
                  ...
                  <tbody>
                    {users && users.length > 0 ? (
                      users.map((user) => (
                        <tr 
                          key={user.id} 
                          className="border-b border-slate-100 dark:border-slate-850 hover:bg-slate-50/40 dark:hover:bg-slate-900/20 text-xs transition-colors"
                        >
                          <td className="py-4 pl-2 font-bold text-slate-400">{user.id}</td>
                          <td className="py-4">
                            <div>
                              <div className="font-extrabold text-slate-800 dark:text-white">{user.name}</div>
                              <div className="text-[10px] text-slate-450 dark:text-slate-500 font-semibold">{user.email}</div>
                            </div>
                          </td>
                          <td className="py-4 font-semibold">
                            <span className="px-2.5 py-1 rounded-lg bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 font-black text-[9px] uppercase tracking-wider">
                              {user.level}
                            </span>
                          </td>
                          <td className="py-4 font-bold text-slate-700 dark:text-slate-350">{user.xp_total} XP</td>
                          <td className="py-4 font-bold text-mathPurple-600 dark:text-mathPurple-400">{user.alby_xp} XP</td>
                          <td className="py-4 font-bold text-amber-600 dark:text-amber-400">🔥 {user.streak_days}</td>
                          <td className="py-4">
                            {user.is_admin ? (
                              <span className="px-2 py-0.5 rounded bg-amber-500/10 border border-amber-500/25 text-amber-600 dark:text-amber-400 text-[9px] font-black uppercase tracking-widest">
                                Admin
                              </span>
                            ) : (
                          ...
                          <td className="py-4 text-right pr-2">
                            <div className="flex items-center justify-end gap-1.5">
                              ...
                              <button
                                ...
                                className="p-1.5 rounded-lg border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 hover:text-mathPurple-500 dark:hover:text-mathPurple-400 transition-all"
                              ...
                              <button
                                ...
                                className="p-1.5 rounded-lg border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 hover:text-amber-500 dark:hover:text-amber-400 transition-all"
                              ...
                              {user.is_admin ? (
                                user.email !== "admin@neuralmath.edu" && (
                                  <button
                                    ...
                                    className="p-1.5 rounded-lg border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 hover:text-red-500 dark:hover:text-red-400 transition-all"
                                ...
                                <button
                                  ...
                                  className="p-1.5 rounded-lg border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 hover:text-blue-500 dark:hover:text-blue-400 transition-all"
                              ...
                              {!user.is_admin && (
                                user.is_active ? (
                                  <button
                                    ...
                                    className="p-1.5 rounded-lg border border-slate-200 dark:border-slate-800 hover:bg-red-500/10 hover:border-red-500/20 text-slate-400 hover:text-red-500 dark:hover:text-red-400 transition-all"
                                  ...
                                  <button
                                    ...
                                    className="p-1.5 rounded-lg border border-slate-200 dark:border-slate-800 hover:bg-green-500/10 hover:border-green-500/20 text-slate-400 hover:text-green-500 dark:hover:text-green-400 transition-all"
            ...
            {totalUsers > userLimit && (
              <div className="flex items-center justify-between border-t border-slate-150 dark:border-slate-850 pt-4 mt-6">
                <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">
                  {language === "es"
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    disabled={userPage === 1}
                    className="p-1.5 rounded-lg border border-slate-200 dark:border-slate-850 hover:bg-slate-100 dark:hover:bg-slate-800 disabled:opacity-40 transition-all"
                  >
        ...
        {/* ==================== 3. CURRICULA TAB ==================== */}
        {activeTab === "curriculum" && (
          <div className="bg-white/80 dark:bg-[#0c1220]/80 backdrop-blur-md rounded-3xl border border-slate-200 dark:border-slate-800/80 shadow-md p-6">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${
                    selectedLevelFilter === lvl
                      ...
                      : "bg-slate-50 dark:bg-[#090d16]/50 border border-slate-200 dark:border-slate-850 text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-white"
                  }`}
                >
                    ...
                    {topics && topics.length > 0 ? (
                      topics.map((topic) => (
                        <tr 
                          ...
                          className="border-b border-slate-100 dark:border-slate-850 hover:bg-slate-50/40 dark:hover:bg-slate-900/20 text-xs transition-colors"
                        >
                          <td className="py-4 pl-2 font-bold text-slate-450">{topic.id}</td>
                          <td className="py-4 font-extrabold text-slate-800 dark:text-white">
                            {topic.name}
                          </td>
                          <td className="py-4 font-bold text-slate-500 dark:text-slate-400">
                            {topic.area}
                          </td>
                          <td className="py-4">
                            <span className="px-2 py-0.5 rounded bg-mathPurple-500/10 text-mathPurple-600 dark:text-mathPurple-400 text-[9px] font-black uppercase tracking-widest">
                              {topic.level}
                            </span>
                          </td>
                          <td className="py-4">
                            <div className="flex flex-wrap gap-1 max-w-[280px]">
                              {topic.subtopics && Array.isArray(topic.subtopics) ? (
                                topic.subtopics.slice(0, 3).map((st: any, sIdx: number) => (
                                  <span 
                                    key={sIdx}
                                    className="px-1.5 py-0.5 bg-slate-100 dark:bg-slate-850 text-slate-550 dark:text-slate-400 text-[8px] font-semibold rounded"
                                  >
                                    {st.name}
                                  </span>
                                ))
                          ...
                          <td className="py-4 text-right pr-2">
                            <button
                              ...
                              className={`px-3 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all ${
                                topic.is_active 
                                  ? "bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-red-500/10 hover:text-red-500" 
                                  : "bg-green-500 text-white shadow-md shadow-green-500/10 hover:bg-green-400"
                              }`}
                            >
        ...
        {activeTab === "agents" && (
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-1 bg-white/80 dark:bg-[#0c1220]/80 backdrop-blur-md rounded-3xl border border-slate-200 dark:border-slate-800/80 shadow-md p-4 space-y-1">
              <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 block px-2 mb-2">
                ...
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-xl text-xs font-bold transition-all flex items-center justify-between group ${
                    selectedAgentKey === agent.agent_key
                      ? "bg-amber-500 text-white shadow-md shadow-amber-500/10"
                      : "text-slate-600 hover:text-slate-850 dark:text-slate-400 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-slate-900/60"
                  }`}
                >
            ...
            <div className="lg:col-span-3 bg-white/80 dark:bg-[#0c1220]/80 backdrop-blur-md rounded-3xl border border-slate-200 dark:border-slate-800/80 shadow-md p-6">
              ...
              {agentsLoading ? (
                ...
                <form onSubmit={handleSaveAgentConfig} className="space-y-6">
                  ...
                  <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-850 pb-4">
                    <div>
                      <h3 className="text-sm font-extrabold capitalize text-slate-850 dark:text-white">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800 text-[10px] font-black uppercase tracking-widest text-slate-550 dark:text-slate-450 transition-all"
                    >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-450 mb-2">
                        {language === "es" ? "Modelo LLM Activo" : "Active AI Model"}
                      </label>
                      <select
                        value={editedModel}
                        onChange={(e) => setEditedModel(e.target.value)}
                        className="w-full bg-slate-50 dark:bg-[#090d16]/50 border border-slate-200 dark:border-slate-800 rounded-xl px-3.5 py-2.5 text-xs font-semibold focus:outline-none focus:border-amber-500 transition-all text-slate-700 dark:text-slate-350"
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full h-2 bg-slate-100 dark:bg-slate-800 rounded-lg appearance-none cursor-pointer accent-amber-500 focus:outline-none py-2"
                      />
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-slate-50 dark:bg-[#090d16]/50 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 text-xs font-medium focus:outline-none focus:border-amber-500 transition-all text-slate-800 dark:text-slate-200 font-mono leading-relaxed"
                      required
                    />
                  </div>
                  ...
                  <div className="flex justify-end">
                    <button
                      ...
                      className="bg-amber-500 hover:bg-amber-400 text-white text-xs font-black uppercase tracking-widest px-6 py-3.5 rounded-2xl shadow-lg shadow-amber-500/10 transition-all hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50"
                    >
            ...
            <div className="flex items-center gap-4 mb-6">
              <div>
                ...
                <select
                  ...
                  className="bg-slate-50 dark:bg-[#090d16]/50 border border-slate-200 dark:border-slate-800 rounded-xl px-3.5 py-2 text-xs font-semibold focus:outline-none focus:border-amber-500 transition-all text-slate-700 dark:text-slate-350"
                >
                    ...
                    {auditLogs && auditLogs.length > 0 ? (
                      auditLogs.map((log) => (
                        <tr 
                          ...
                          className="border-b border-slate-100 dark:border-slate-850 hover:bg-slate-50/40 dark:hover:bg-slate-900/20 text-xs transition-colors"
                        >
                          <td className="py-4 pl-2 font-bold text-slate-450">
                          ...
                          <td className="py-4">
                            <span className="px-2 py-1 rounded bg-slate-100 dark:bg-slate-800 text-slate-650 dark:text-slate-400 text-[9px] font-black uppercase tracking-widest border border-slate-200/50 dark:border-slate-800/80">
                              {log.action}
                            </span>
                          </td>
                          ...
                          <td className="py-4 pr-2">
                            <pre className="text-[10px] font-mono text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-slate-950/40 p-2 rounded-lg border border-slate-200/40 dark:border-slate-800/30 overflow-x-auto max-w-sm scrollbar-none">
      ...
      {showTempPasswordModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-black/60 backdrop-blur-sm">
          <div className="w-full max-w-md bg-white dark:bg-[#0c1220] border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-2xl relative overflow-hidden">
            <div className="absolute -top-12 -right-12 w-24 h-24 bg-amber-500/10 rounded-full blur-xl pointer-events-none" />
            
            <div className="flex flex-col items-center text-center space-y-4">
              <div className="w-14 h-14 bg-amber-500/10 border border-amber-500/30 text-amber-500 rounded-2xl flex items-center justify-center text-xl font-bold shadow-inner">
              ...
              <div className="space-y-2 w-full">
                ...
                <p className="text-slate-550 dark:text-slate-400 text-xs font-medium leading-relaxed">
                  {language === "es"
                ...
                <div className="bg-slate-50 dark:bg-slate-950/40 p-4 rounded-xl border border-slate-200/60 dark:border-slate-800 select-all font-mono text-base font-black tracking-widest text-amber-600 dark:text-amber-400 shadow-inner mt-4">
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-white text-[10px] font-black uppercase tracking-widest transition-all shadow-md shadow-amber-600/10 mt-6"
              >
      ...
      {showXpModal && xpEditUser && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-black/60 backdrop-blur-sm">
          <div className="w-full max-w-sm bg-white dark:bg-[#0c1220] border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-2xl relative">
            <h3 className="text-base font-bold text-slate-850 dark:text-white mb-2 flex items-center gap-2">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-[#090d16]/50 border border-slate-200 dark:border-slate-800 rounded-xl px-3.5 py-2.5 text-sm font-semibold focus:outline-none focus:border-amber-500 transition-all text-slate-800 dark:text-white"
              ...
              <div className="flex gap-3 pt-4 border-t border-slate-100 dark:border-slate-850">
                <button
                  ...
                  className="flex-1 py-3 px-4 rounded-xl border border-slate-250 dark:border-slate-800 text-slate-500 dark:text-slate-450 hover:bg-slate-100 dark:hover:bg-slate-800 text-[10px] font-black uppercase tracking-widest transition-all"
                >
                ...
                <button
                  ...
                  disabled={savingXp}
                  className="flex-1 py-3 px-4 rounded-xl bg-amber-500 hover:bg-amber-400 text-white text-[10px] font-black uppercase tracking-widest transition-all shadow-md shadow-amber-500/10"
                >
      ...
      {showHistoryModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-black/60 backdrop-blur-sm">
          <div className="w-full max-w-4xl bg-white dark:bg-[#0c1220] border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-2xl relative overflow-hidden flex flex-col max-h-[85vh]">
            <div className="absolute -top-12 -right-12 w-24 h-24 bg-amber-500/10 rounded-full blur-xl pointer-events-none" />
            
            <h3 className="text-base font-bold text-slate-850 dark:text-white mb-1 flex items-center gap-2 border-b border-slate-100 dark:border-slate-850 pb-3">
                ...
                <tbody>
                  {agentHistory && agentHistory.length > 0 ? (
                    agentHistory.map((hist) => (
                      <tr 
                        key={hist.id} 
                        className="border-b border-slate-100 dark:border-slate-850 hover:bg-slate-50/40 dark:hover:bg-slate-900/20 text-[11px] transition-colors"
                      >
                        <td className="py-4 pl-2 font-bold text-slate-450 whitespace-nowrap">
                          {new Date(hist.created_at).toLocaleString()}
                        </td>
                        <td className="py-4 font-bold text-slate-700 dark:text-slate-350 whitespace-nowrap">
                          {hist.admin_email}
                        </td>
                        <td className="py-4 whitespace-nowrap">
                          <div>
                            <span className="font-bold">{hist.model_name}</span>
                            <span className="text-[10px] text-slate-400 block">t = {hist.temperature}</span>
                          </div>
                        </td>
                        <td className="py-4">
                          <div className="max-w-xs md:max-w-md truncate font-mono text-[10px] bg-slate-50 dark:bg-slate-950/20 p-2 border border-slate-200/50 dark:border-slate-800/80 rounded-lg">
                            {hist.system_prompt}
                          </div>
                        </td>
                        <td className="py-4 text-right pr-2">
                          <button
                            ...
                            className="bg-amber-500 hover:bg-amber-400 text-white text-[9px] font-black uppercase tracking-widest px-3 py-1.5 rounded-xl shadow transition-all whitespace-nowrap"
                          >
            ...
            <div className="flex justify-end border-t border-slate-100 dark:border-slate-850 pt-3">
              <button
                ...
                className="py-3 px-5 rounded-xl border border-slate-250 dark:border-slate-800 text-slate-650 dark:text-slate-350 hover:bg-slate-100 dark:hover:bg-slate-800 text-[10px] font-black uppercase tracking-widest transition-all"
              >
